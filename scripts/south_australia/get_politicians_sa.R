#### Preamble ####
# Purpose: The purpose of this script is to download all of the pages for South Australian politicians.
...
get_bio <- function(address){
  ...
  save_name <- str_remove(address, "https://members.parliament.sa.gov.au/Detail.aspx\\?pid=") %>% 
    paste0("inputs/data/south_australia/politicians/", ., ".html")
...
#### Use the function ####
all_former_politicians <- read_csv("outputs/data/south_australia/list_of_all_former_politicians.csv")
